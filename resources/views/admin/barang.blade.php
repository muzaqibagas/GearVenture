                  ...
                  <thead>
                    <tr>
                      ...
                      <th class="text-secondary text-center">
                        <a class="btn text-center text-white btn-sm w-100 btn-primary rounded mb-0 px-0" href="tambahbarang">Tambah+</a>
                      </th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <p class="text-xs font-weight-bold mb-0">Tenda</p>                        
                      </td>
                      <td>
                        <p class="text-xs font-weight-bold mb-0">Rp40.000</p>
                      </td>
                      <td>
                      <p class="text-xs font-weight-bold mb-0">10</p>
                      </td>
                      <td>
                        <p class="text-xs font-weight-bold mb-0">Lorem Ipsum</p>
                      </td>
                      <td class="text-center">                                                
                        <a href="editbarang" class="fa6-solid--pen"></a>
                        <a href="" class="mdi--trash-can-empty"></a>                        
                      </td>
                    </tr>                
                  </tbody>
                </table>
