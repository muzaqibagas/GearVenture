...
<head>
  ...
  <link id="pagestyle" href="{{ asset('css/barang.css?v=1.1.0') }}" rel="stylesheet" >
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder mb-0">Manajemen Barang</h6>
        </nav>  
                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-secondary text-center">
                        <a class="btn text-center text-white btn-sm w-100 btn-primary rounded mb-0 px-0" href="{{ route('tambahbarang') }}">Tambah+</a>
                      </th>
                    </tr>
                  </thead>
                  <tbody>  
                  ...
                  @foreach ($data as $dabar)                  
                    <tr>
                      ...
                      <td>
                        <p class="text-xs font-weight-bold mb-0">{{ $dabar->kategori->nama ?? 'Tidak ada kategori' }}</p>                        
                      </td>
                      <td>
                        <p class="text-xs font-weight-bold mb-0">Rp {{ number_format($dabar->harga_sewa, 0, ',', '.') ?? 'Harga tidak tersedia' }}</p>
                      </td>
                      <td>
                      <p class="text-xs font-weight-bold mb-0">{{$dabar->stok}}</p>
                      </td>
                      <td>
                        <p class="text-xs font-weight-bold mb-0">{{$dabar->deskripsi}}</p>
                      </td>
                      <td class="text-center">                                                
                        <a href="{{ route('editbarang', $dabar->id) }}" class="fa6-solid--pen"></a>
                        <a href="{{ route('deletebarang', $dabar->id) }}" class="mdi--trash-can-empty"></a>                  
                      </td>
                    </tr>  
                  @endforeach              
                  </tbody>
