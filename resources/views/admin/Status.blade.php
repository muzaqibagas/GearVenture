...
<head>
  ...
  <link id="pagestyle" href="{{ asset('css/laporan.css?v=1.1.0') }}" rel="stylesheet" >
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Manajemen Transaksi</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Status</h6>
        </nav>
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          ...
          <ul class="navbar-nav  justify-content-end">
            <li class="nav-item d-flex align-items-center">
              <a class="btn btn-white btn-sm mb-0 me-3 text-primary" href="laporan">Laporan</a>
            </li>
            <li class="nav-item d-flex align-items-center">
              <a class="btn btn-primary btn-sm mb-0 me-3" href="status">Status</a>
            </li>
