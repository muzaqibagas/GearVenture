...
<body class="g-sidenav-show  bg-gray-100">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          ...
          <div class="collapse" id="menuBarang">
            <ul class="nav ms-4 ps-3 list-unstyled">
              <li class="nav-item">
    ...
    <div class="container-fluid py-4">
      <div class="row">
        ...
        <div class="col-lg-6 col-12 mt-4 mt-lg-0">          
          <div class="container d-flex mt-0 justify-content-center ">
            <div class="notification-card">
              <div class="notification-header">
                <div class="icon-container">
                  <span class="iconamoon--notification-light"></span>
                </div>
      ...
      <div class="row mt-4">
        ...
        <div class="col-lg-5 mb-lg-0 mb-4">
          <div class="card z-index-2">            
            <div class="card-header pb-0">
              <h6>Grafik Pengguna(/thn)</h6>              
            </div>
            <div class="card-body p-3">
              <div class="chart">
                <canvas id="genderPieChart" class="chart-canvas" height="300"></canvas>              
              </div>
            </div>
          </div>
        </div>
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/w/5.3.2/js/bootstrap.bundle.min.js"></script>
