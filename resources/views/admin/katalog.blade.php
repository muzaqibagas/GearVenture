  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="{{ route('konten') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>box-3d-50</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
          ...
          <div class="card-header pb-0">
            <ul class="navbar-nav d-flex flex-row gap-3">
                <li class="nav-item d-flex align-items-center justify-content-start pb-3">
                    <a href="{{ route('konten') }}" class="btn btn-primary btn-sm w-100 mb-0">Konten</a>
                </li>
                <li class="nav-item d-flex align-items-center justify-content-start pb-3">
                    <a href="{{ route('katalog') }}" class="btn btn-white btn-sm w-100 mb-0 active">Katalog Populer</a>
                </li>
                <li class="nav-item d-flex align-items-center justify-content-start pb-3">
                    <a href="{{ route('events') }}" class="btn btn-primary btn-sm w-100 mb-0">Info Event</a>
                </li>                        
            </ul>
