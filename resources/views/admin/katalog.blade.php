        ...
        <div class="col-12">
          <div class="card-header pb-0">
            <ul class="navbar-nav d-flex flex-row gap-3">
                ...
                <li class="nav-item d-flex align-items-center justify-content-start pb-3">
                    <a href="{{ url('admin/pengaturan?page=katalog') }}" class="btn btn-white btn-sm w-100 mb-0 active">Katalog Populer</a>
                </li>
                <li class="nav-item d-flex align-items-center justify-content-start pb-3">
                    <a href="{{ url('admin/pengaturan?page=event') }}" class="btn btn-primary btn-sm w-100 mb-0">Info Event</a>
                </li>                        
            </ul>
                  ...
                  <thead>
                    <tr>
                      ...
                      <th class="align-middle text-secondary">
                        <a class="d-flex justify-content-center btn btn-primary btn-sm w-100 mb-0" href="tambahkatalog">Tambah+</a>
                      </th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
                      ...
                      <td class="tombol align-middle d-flex flex-column gap-1">                                                
                        <a href="editkatalog" class="btn text-center text-white btn-sm w-100 btn-warning rounded mb-0">Edit</a>
