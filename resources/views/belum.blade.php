    ...
    <div class="d-flex">
        <aside class="sidenav navbar-vertical navbar-expand-xs border-0 border-radius-xl fixed-start rounded p-3 " style="width:230px" id="sidenav-main">
            <div class="sidebar d-flex flex-column text-dark">
                ...
                <ul class="nav nav-pills nav-fill">                                                          
                    <li class="nav-item">
                        <a class="d-flex align-items-center rounded p-2 bg-white text-decoration-none text-dark shadow" href="profile">
                            ...
                            <span class="nav-link-text ms-1 green">Belum Dibayar</span>
                        </a>
                    </li>                    
                    <li class="nav-item">
                        <a class="d-flex align-items-center rounded p-2 text-decoration-none text-dark" href="profile">
        ...
        <div class="ms-5" style="width:80%">
            <div class="card border-0 shadow rounded" style="background-color: #393e1d;">
                <div class="p-4">
                ...
                <table class="table text-white">
                    ...
                    <tr class="align-middle border-top">
                        ...
                        <img src="{{ asset('img/profile.jpg') }}" width="60" height="60" style="object-fit: cover;" alt="Bangku">
                        Bangku
                        </td>
                    ...
                    <tr class="align-middle border-top">
                        <td class="d-flex align-items-center gap-3">
                        <img src="{{ asset('img/profile.jpg') }}" width="60" height="60" style="object-fit: cover;" alt="Bangku 4P">
                        Bangku 4P
                        </td>
