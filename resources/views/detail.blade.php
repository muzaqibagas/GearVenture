...
<section class="catalog py-4"> 
    ...
    <div class="row mt-3 d-flex justify-content-center gap-3">
            ...
            <div class="row">
                @foreach ($dacak as $dabar)  
                    <div class="col-6 mb-4">
                        ...
                        @endif                        
                        <a href="{{ url('/detail/' . $dabar->id) }}" class="mb-0 mt-2 text-decoration-none text-dark">{{ $dabar->nama }}</a>                        
        ...
        <div class="col-lg-4 product-container">
            ...
            <p class="border-2 border-bottom border-dark pb-1 mb-2">
                <strong>Ketersediaan:</strong>
                @if ($data->stok > 0)
                    <span class="fw-bold" style="color:#c3d234">Tersedia</span>
                @else
            ...
            @else
                <div class="alert alert-danger mt-3">
                    Produk ini sedang <strong>habis</strong> dan tidak dapat dimasukkan ke keranjang.
                </div>
            @endif
        </div>
    </div>
