...
@section('main')
  ...
  <div class="container py-4">
    ...
    <div class="d-flex justify-content-between top-buttons">
      <a href="about"class="d-flex justify-content-center align-items-center text-decoration-none rounded-top text-white fw-bold active-button" style="width:200px; height: 30px;"><i class="bi bi-credit-card me-2"></i>Pembayaran</a>      
